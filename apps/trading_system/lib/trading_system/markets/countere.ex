defmodule TradingSystem.Markets.Counter do
  ...
  embedded_schema do
    ...
    field :lot_size, :integer, virtual: true, default: 1
    field :atr, :float, virtual: true
    field :trade, :string, virtual: true, default: :bull
  end

  @required_fields ~w(account position atr_account_ratio atr_add_step atr_stop_step buy_price lot_size atr trade)a
  @optional_fields ~w()a
