...
class HKStockDetail extends React.Component {
  ...
  dataHandler(data) {
    ...
    result['highest'] = this.currency(data['highest'])
    result['lowest'] = this.currency(data['lowest'])
    result['year_highest'] = this.currency(data['year_highest'])
    result['year_lowest'] = this.currency(data['year_lowest'])
          ...
          <div className="column">
            <table className="table">
              <tbody>
                ...
                <tr>
                  <th>52周最高：</th>
                  <td>{data.year_highest}</td>
                </tr>
                <tr>
                  <th>52周最低：</th>
                  <td>{data.year_lowest}</td>
                </tr>
                <tr>
                  <th>振幅：</th>
...
query HKStockDetail($symbol: String!){
...
export default graphql(graphqlQuery, graphqlOptions)(HKStockDetail)